...
var querySuccessApplyStatus = function () {
    return new Promise(function (resolve, reject) {
        console.log('run querySuccessApplyStatus----------------------------');
        ...
        Fabric_Client.newDefaultKeyValueStore({
            ...
            if (query_responses && query_responses.length == 1) {
                if (query_responses[0] instanceof Error) {
                    ...
                    resolve(stuList);
                    console.log('end querySuccessApplyStatus----------------------------');
                }
            } else {
...
// GET /querySuccessApplyStatus 
router.get('/', checkLogin, function (req, res, next) {
    querySuccessApplyStatus().then((result) => {
        getStuList = result
        res.render('manager/querySuccessApplyStatus', { stuLists: result })
    })
})

// POST /querySuccessApplyStatus 
router.post('/', checkLogin, async function (req, res, next) {
    ...
    try {
        ...
        return res.redirect('/manager/querySuccessApplyStatus')
    }
